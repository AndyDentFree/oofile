...
///////////////////////////////////////////////////////////////////////////////
// The tree control doesn't support multiple selection. However we can simulate 
...
/*
	ES - Item editing must be performed in OnLButtonUp, not here
...
/////////////////////////////////////////////////////////////////////////////
// Static function to retreive a HTREEITEM from a tree control, given the 
// item's itemdata.

HTREEITEM CTreeCtrlEx::GetTreeItemFromData(CTreeCtrl& treeCtrl, DWORD dwData, HTREEITEM hStartAtItem /*=NULL*/)
{
