...
class	CYNCDlg :	public LDialogBox {
...
CYNCDlg::FinishCreateSelf()
{
	...
	mButton1 = (LStdButton *)FindPaneByID ('But1');
	mButton2 = (LStdButton *)FindPaneByID ('But2');
	mButton3 = (LStdButton *)FindPaneByID ('But3');
	mText = (LCaption*)FindPaneByID('mtxt');
...
oofYNC::msgBox()
{
	...
	SysBeep(1);	// NOT YET IMPLEMENTED - make this optional, or set sound
